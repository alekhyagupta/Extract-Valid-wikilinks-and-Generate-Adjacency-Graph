...
public class MapperOutput1 extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {

    private static final Pattern wikiLinksExp = Pattern.compile("\\[.+?\\]");
